...
CALL addRoute("MIT", "HOB");
SELECT id INTO @last_route FROM ba_route WHERE departure = "MIT" AND arrival = "HOB";
CALL addRoutePrice(@last_route, 2010, 2000);
CALL addRoutePrice(@last_route, 2011, 2100);

CALL addRoute("HOB", "MIT");
SELECT id INTO @last_route FROM ba_route WHERE departure = "HOB" AND arrival = "MIT";
CALL addRoutePrice(@last_route, 2010, 1600);
CALL addRoutePrice(@last_route, 2011, 1500);
