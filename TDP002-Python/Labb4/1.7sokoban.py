...
def player_move(dir):
    ...
    elif (game_board[player_y+ y_offset][player_x + x_offset] == tiles["box"] or game_board[player_y+ y_offset][player_x + x_offset] == tiles["storage_box"]) and box_can_move(dir, player_y + y_offset, player_x + x_offset):
    ...
    elif (game_board[player_y + y_offset][player_x + x_offset] == tiles["box"] or game_board[player_y + y_offset][player_x + x_offset] == tiles["storage_box"]) and not box_can_move(dir, player_y + y_offset, player_x + x_offset):
        did_move = False
...
def box_move(dir, box_y, box_x):
    ...
    if game_board[box_y][box_x] == tiles["storage_box"]:
        game_board[box_y][box_x] = tiles["storage"]
    else:
...
def box_can_move(dir, box_y, box_x):
    ...
    if game_board[box_y + y_offset][box_x + x_offset] == tiles["wall"] or game_board[box_y + y_offset][box_x + x_offset] == tiles["box"] or game_board[box_y + y_offset][box_x + x_offset] == tiles["storage_box"]:
        can_move = False
