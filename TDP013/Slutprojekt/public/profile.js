...
window.onload = function()
{
	...
	{
		// Get user profile data through AJAX
		...
		document.getElementById("dm-link").setAttribute("href", "privateChat.html?friendName="+username);
	...
	if(msg != undefined && msg != "")
	{
		...
		xhttp.onreadystatechange = function()
		{
			if(this.readyState == 4 && this.status == 200)
			{
				...
				app.messageList.push({message : msg, user : app.myName});
			}
			else if(this.readyState == 4)
			{
				alert("Wierd shit happened");
